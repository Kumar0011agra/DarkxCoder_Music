...
OWNER_ID = int(getenv("OWNER_ID", 6632406122))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+xeryDhybdok5MWI1")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/MAHAKAL_KI_NAGRI_11")
